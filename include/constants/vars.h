...
#define VAR_PETALBURG_INTRO_STATE                        0x404E // custom var for Petalburg City intro, used to track the player's progress through the intro sequence. See data/maps/PetalburgCity/scripts.pory
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_PETALBURG_HOUSE_STATE                        0x4052 // custom var for Petalburg City intro, used to track whether or not the player has entered the house in the intro sequence. See data/maps/PetalburgCity/scripts.pory
